...
namespace SamuraiAppCore.Data.Migrations
{
    ...
    [Migration("20170730035526_addprocs")]
    partial class addprocs
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SamuraiAppCore.Domains.Warrior", b =>
                {
            ...
            modelBuilder.Entity("SamuraiAppCore.Domains.Warrior", b =>
                {
                    b.HasOne("SamuraiAppCore.Domains.Samurai", "Samurai")
                        .WithOne("Warrior")
                        .HasForeignKey("SamuraiAppCore.Domains.Warrior", "SamuraiId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
        }
    }
